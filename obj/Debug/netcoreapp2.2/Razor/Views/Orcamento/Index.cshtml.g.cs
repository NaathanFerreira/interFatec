#pragma checksum "C:\Users\Nathan\Desktop\InterFinal\Inter2.2.1\Inter2.2.1\Views\Orcamento\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a049459d7468031b9a2d124fe55d0ab804bc9af8"
// <auto-generated/>
...
#line 1 "C:\Users\Nathan\Desktop\InterFinal\Inter2.2.1\Inter2.2.1\Views\Orcamento\Index.cshtml"
using Inter2.Models;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a049459d7468031b9a2d124fe55d0ab804bc9af8", @"/Views/Orcamento/Index.cshtml")]
    public class Views_Orcamento_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 2 "C:\Users\Nathan\Desktop\InterFinal\Inter2.2.1\Inter2.2.1\Views\Orcamento\Index.cshtml"
  
    Layout = "~/Views/Shared/Layout.cshtml";

#line default
#line hidden
            BeginContext(75, 10781, true);
            WriteLiteral(@"
<style>
...
<div class=""modal fade"" id=""modal_adicionar_orcamento"" tabindex=""-1"" role=""dialog"" aria-labelledby=""exampleModalLabel"" aria-hidden=""true"" data-backdrop=""static"" data-keyboard=""false"">
    <div cla");
            WriteLiteral(@"ss=""modal-dialog modal-xl modal-dialog-centered"" role=""document"">
                        ...
                        <div class=""form-row"">
                            <div class=""col-md-6 mb-3"">
                                <label for=""funcionario_adicionar_orcamento"">Funcionário&nbsp;<span class=""text-danger"">*</span></label>
                                 <select class=""form-control"" name=""IdFuncionario"" id=""funcionario_adicionar_orcamento"" requi");
            WriteLiteral(@"red>
                ...
                <div class=""modal-footer"">
                 ");
            WriteLiteral(@"   <button type=""button"" class=""btn btn-danger"" data-dismiss=""modal""><i class=""fas fa-times""></i>&nbsp;&nbsp;Cancelar</button>
...
<script>
    ...
    $(""#form_adicionar_orcamento"").submit(f");
    ...
    function carregarTabelaProdutos(){
        $.ajax({
            ...
            success: function(e) {
                if (e != """") {
                    ...
                    var cabecalho = ""<table class='table table-responsive-sm' cellspacing='0'>\n"" +
                           ");
            WriteLiteral(@"             ""<thead class='text-center'>""+
                                            ""<tr>""+
                                                ""<th>Produto</th>""+
            ...
            WriteLiteral(@"                  ""</td>""+
                                                            ...
                                                            ""<td>R$&nbsp;"" 
                                                                + e[i].Preco + 
                                                                ""<input name='Preco' type='hidden' value='""+e[i].P");
            WriteLiteral(@"reco+""'>""+
                                                            ""</td>""+
                                                        ""</tr>"";
                                            }
    ...
    function carregarClientes(){
        $.ajax({
            method: 'POST',
       ");
            WriteLiteral(@"     url: '/Cliente/ViewCli',
            dataType: 'json',
            global: false,
            success: function (e) {
                for (var i = 0; i < e.length; i++) {
